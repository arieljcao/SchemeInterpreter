...
; expect (lambda x (lambda y (lambda z (+ x y z))))

(define (temp x y) (* 3 (+ x y)))
; expect temp

temp
; expect (lambda (x y) (* 3 (+ x y)))

(define (temp x y) (define (HOP z v) (* (+ x v)(+ z y))) HOP)
; expect temp

(temp 10 10)
; expect (lambda (z v) (* (+ x v) (+ z y)))
...
(let ((x 100) (y 200) (z 300)) (+ x y z))
; expect 600

(let ((x 100) (y 200) (k (let ((z 300) (v 500)) (+ z v)))) (+ x y k))
; expect 1100

(define f (mu (x) (* x y)))
; expect f

(define g (lambda (x y) (f ( f(* x x)))))
; expect g
